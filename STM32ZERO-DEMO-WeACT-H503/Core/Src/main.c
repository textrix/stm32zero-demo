...
void PeriphCommonClock_Config(void)
{
  ...
  */
  PeriphClkInitStruct.PeriphClockSelection = RCC_PERIPHCLK_ADCDAC|RCC_PERIPHCLK_FDCAN
                              ...
                              |RCC_PERIPHCLK_I2C2|RCC_PERIPHCLK_I3C1;
  ...
  PeriphClkInitStruct.I2c1ClockSelection = RCC_I2C1CLKSOURCE_PLL2R;
  PeriphClkInitStruct.I2c2ClockSelection = RCC_I2C2CLKSOURCE_PLL2R;
  PeriphClkInitStruct.I3c1ClockSelection = RCC_I3C1CLKSOURCE_PLL2R;
...
static void MX_TIM2_Init(void)
{
  ...
  htim2.Instance = TIM2;
  htim2.Init.Prescaler = (240-1) /* 240Mhz / 240 = 1Mhz = 1us */;
...
static void MX_TIM3_Init(void)
{
  ...
  HAL_TIMEx_RemapConfig(&htim3, TIM_TIM3_ETR_TIM2_ETR);
