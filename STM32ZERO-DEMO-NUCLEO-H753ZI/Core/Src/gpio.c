...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin : USB_FS_OVER_Pin */
  GPIO_InitStruct.Pin = USB_FS_OVER_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(USB_FS_OVER_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : USB_OTG_FS_SOF_Pin PA10 */
  GPIO_InitStruct.Pin = USB_OTG_FS_SOF_Pin|GPIO_PIN_10;
