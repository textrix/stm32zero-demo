...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, LD1_Pin|TP1_Pin|LD2_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : LD1_Pin TP1_Pin LD2_Pin */
  GPIO_InitStruct.Pin = LD1_Pin|TP1_Pin|LD2_Pin;
  ...
  /*Configure GPIO pins : FDCAN1_RX_EXTI_Pin USB_FS_OVER_Pin */
  GPIO_InitStruct.Pin = FDCAN1_RX_EXTI_Pin|USB_FS_OVER_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  /*Configure GPIO pin : TP0_Pin */
  GPIO_InitStruct.Pin = TP0_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(TP0_GPIO_Port, &GPIO_InitStruct);
